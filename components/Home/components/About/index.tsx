...
const About = () => {
  ...
  const [totalCardanoSpent, setTotalCardanoSpent] = useState(0);
  const [totalCardanoBurned, setTotalCardanoBurned] = useState(0);
  ...
  useEffect(() => {
    ...
    VotingHubWrapper?.totalTollBurned().then(
      (value) => {
        value ? setTotalCardanoBurned(Number(value) / 10 ** 18) : setTotalCardanoBurned(0);
      }
    );
      ...
      <div className={styles.container}>
        ...
        <div className={styles.infos}>
          <div className={styles.row}>
            <div className={styles.left}>Total Cardano toll paid:</div>
            <div className={styles.right}>{totalTollPaid}</div>
          </div>

          <div className={styles.row}>
            <div className={styles.left}>Total Cardano burned:</div>
            <div className={styles.right}>{totalCardanoBurned}</div>
          </div>

          <div className={styles.row}>
            <div className={styles.left}>Total Cardano distributed:</div>
            <div className={styles.right}>{totalCardanoSpent}</div>
          </div>
        </div>
          ...
          <div className={styles.social}>
            ...
            />
            <img
              onClick={() => window.open("https://twitter.com/CardanoGovXDAO")}
