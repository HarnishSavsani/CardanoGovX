...
const ProposalEditorComponent = () => {
  ...
  useEffect(() => {
    if (core && treasury && CARDANO && urgent) {
      setDropdown(false);
    } else {
      setDropdown(true);
    }
    let tags = [core ? "CORE" : "", treasury ? "TREASURY" : "", CARDANO ? "CARDANO_COMMUNITY" : "", urgent ? "URGENT" : ""];
    tags = tags.filter((tag) => tag !== "");
    setTags(tags)
  }, [core, treasury, CARDANO, urgent]);
          ...
          <div className={styles.userOptions}>
            ...
            <div className={styles.rightContainer}>
              ...
              <div onClick={() => {
                ...
                .then((tx: any) => {
                  setCurrentMessage("Proposal is being listed to CardanoGovX. Please wait...")
                  try {
                    votingHub?.proposalCount().then((count: any) => {
                      ...
                      votingHub?.tollBurnPercentage().then((burn: any) => {
                        createProposal({
                          ...
                          burnAddress: "CARDANO0000000000000000000000000000000000000000",
                          communityPercentage: 100 - Number(burn),
                          communityAddress: "CARDANO0000000000000000000000000000000000000000",
            ...
            <div className={styles.tagInput}>
              ...
              <div className={styles.input}>
                ...
                {CARDANO == true ? (
                  ...
                  >
                    <div className={styles.text}>CARDANO Community</div>
            ...
            <div className={styles.inputRow}>
              <div className={styles.votingToll}>
                ...
                <div className={styles.input}>
                  <input
                    type="number"
                    alt="Min: 0 CARDANO Max: 100000 CARDANO"
                    value={toll}
                    onChange={(e) => {
