          ...
          <div className={styles.wrapper}>
            ...
            <div className={styles.content}>
              ...
              <div className={styles.description}>
                ...
                <br />
                <br />
                <strong>Risks related to use of CARDANO Tokens</strong>
                <br />
                CARDANO Tokens, powered by CARDANO Network’s XDPoS consensus protocol, are private instruments which are not necessarily registered with any regulatory agency of any jurisdiction, and may not be subject to the same regulatory requirements as securities, exchange traded funds, mutual funds, or the like which would be registered with appropriate regulatory authorities (e.g., the Monetary Authority of Singapore or the Securities and Exchange Commission in the United States).  This is likely true of all tokens described in, referred to, or created on the Website.  Because CARDANO Tokens are not registered instruments, any information on the Website or elsewhere purporting to relate to pricing and valuation likely lacks the standardization and reliability typical of investment instruments.  CARDANO Tokens have not been reviewed or approved by federal, state, or local regulators of any jurisdiction.
                <br />
                <br />
                You should carefully note the following:
                <br />
                <br />
                To the extent any person would purchase or receive CARDANO Tokens for investment purposes, such investment is purely speculative investment and involves a high degree of risk. Any investor can lose all or a considerable portion of his or her investment, but this is particularly true with an investment that is unregulated.  The value of unregulated assets can drop to zero in less time than it takes to read these Terms of Use.  In addition, the process of creating a token is subject to error and any error committed by you or any other person while creating a token can have unexpected results.  In other words, the functionality of a token created on the Website may be unpredictable and should not be relied on for any purpose.
                <br />
                <br />
                Anyone planning to invest in any cryptocurrency, digital token, or CARDANO Token must have appropriate sophistication, experience, financial ability, and willingness to bear risks of an investment.  You should not assume you are such a person.  No investment in CARDANO Tokens should ever be made in an amount greater than the maximum loss you are willing and able to bear.
                <br />
                <br />
                Fees and expenses associated with transfer of CARDANO Tokens (which may be considerable, regardless of any other factors) may offset any trading profits that might be realized through the creation, ownership, purchase, sale, and exchange of CARDANO Tokens.
                <br />
                <br />
                ...
                <br />
                <br />
                These few risks described here are not a complete list of risks associated with reliance on the information set forth on the Website.  Other disclosures, which would be deemed necessary in order to make a knowing and informed investment, may be available on other websites or from other sources; such sources ought to be carefully reviewed prior to creating, owning, purchasing, trading, exchanging, staking, or selling CARDANO Tokens or otherwise incurring any risk associated therewith.
                <br />
                <br />
                <strong>Investment Risks</strong>
                <br />
                The price of CARDANO Tokens is highly volatile and you should expect prices to have wide-ranging fluctuations. Any investment in CARDANO Tokens can lead to loss of money over short or long periods. “Cryptocurrency” trading is not appropriate for all users of the Website and may not be appropriate for you. Anyone who is planning to invest in cryptocurrencies should consult a well-qualified, independent, and professional financial advisor. The information published on the Website is not a suitable replacement for such an advisor and cannot guarantee that a creator, owner, purchaser, or seller of CARDANO Tokens will not lose money.
                <br />
                <br />
                <strong>No Investment Advice</strong>
                <br />
                The entire body of information given on the Website does not consist of or include investment advice, trading advice, financial advice, technical advice, or any other kind of advice.  Under no circumstance should you take any of the Website’s content, including data, as advice or as information that is suitable to support an important decision. The site owner never recommends that you create, own, buy, sell or hold any CARDANO Tokens or participate or invest in any property or idea described on the Website.  Nothing on the Website should be considered as a proposal or recommendation that you create, own, buy, sell or hold any CARDANO Tokens. The closest thing to advice we can offer you is to emphatically state that you should fully conduct your own due diligence and consult one or more qualified professional financial advisors before you make any investment decisions.
                <br />
                <br />
                ...
                <br />
                In no event shall the site owner be liable for any direct, indirect, special or consequential damages of any kind, including, but not limited to, loss of use, loss of profits, loss of tokens, or loss of data arising out of or in any way connected with the use of the Website or <strong>CARDANO Tokens</strong>.
                <br />
                <br />
